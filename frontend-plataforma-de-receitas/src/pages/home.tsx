...
import { BookOpenCheck, FileText, Search, Timer } from "lucide-react";
  ...
  return (
    <div className="py-6 w-full text-left">
      ...
      {activeScans.map((scan) => (
        <div key={scan.courseId} className="mt-6 bg-neutral-100 dark:bg-neutral-800 px-4 py-3 rounded-md">
          <div className="flex items-center justify-between mb-2">
            <p className="text-sm font-medium">Atualizando aulas...</p>
